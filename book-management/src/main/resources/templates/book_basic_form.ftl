		  ...
		  <div class="form-input form-category">
            <div class="form-input form-category-select">
              ...
              <#list body as item>
				...
				<div class="form-input">
					<input type="text" class="input input-age" data-type="price" placeholder="가격*" name="price" value="">
				</div>
				<div class="form-input">
					<input type="text" class="input input-age" data-type="year" placeholder="출판년도*" name="year" value="">
				</div>
				<div class="form-input">
					<input type="text" class="input input-age" data-type="stock" placeholder="재고*" name="stock" value="">
				</div>
                   <div class="form-input">
