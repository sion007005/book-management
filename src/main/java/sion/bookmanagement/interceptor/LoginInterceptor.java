...
public class LoginInterceptor implements Interceptor {
	...
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Commander controller) {
	...
	@Override
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Commander controller) {
...
//		response.getModelAndView().getModel().put("_user", UserContext.get());
	...
	private void loginCheck(Commander controller) {
